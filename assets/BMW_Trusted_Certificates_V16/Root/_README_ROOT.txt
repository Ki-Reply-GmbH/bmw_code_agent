July 19 2019
These Root CA certificates should be added to any default trust stores on BMW Group systems.
...
Please be sure all base images, containers, application deployments, etc. contain these in the trust store at a minimum.
